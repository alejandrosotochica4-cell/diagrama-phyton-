...
# imprimir texto
    ...
    def realizar_reclamacion(self):
        print(f"{self.nombre} ha realizado una reclamación .")
...
class Procesador:
    ...
    def mandar_articulo_online(self):
        print("Procesador: Mandando artículo online al sistema .")
    ...
    def actualiza_catalogo(self):
        print("Procesador: Actualizando catálogo de productos .")
...
def main():
    ...
    producto = Libro(50000, "100 Años de Seriedad", "fabian ruiz", "Planeta", 2020, "juveneil", "Ficcion")
